  ...
  const features = [
    {
      ...
      description:
        "Learns from interactions to build a comprehensive framework of human preferences and behaviors.",
    },
    {
      icon: <Zap className="h-6 w-6" />,
      title: "Adaptive Learning",
      description:
        "Continuously refines its approach based on feedback and changing environments.",
    },
    {
      icon: <Users className="h-6 w-6" />,
      title: "Natural Collaboration",
      description:
        "Works alongside humans with an intuitive understanding of unspoken social dynamics.",
    },
    {
      icon: <Check className="h-6 w-6" />,
      title: "Predictive Assistance",
      description:
        "Anticipates needs before they're expressed, providing proactive support.",
    },
  ];
              ...
              <div className="absolute bottom-4 left-8 right-8 bg-white/80 backdrop-blur-sm p-4 rounded-xl shadow-sm">
                <div className="flex items-center space-x-2">
                  ...
                  <p className="text-sm font-medium">
                    Atlas AI actively processing human behavior patterns
                  </p>
                </div>
              </div>
            </div>
